...
const jsStages = [
    ...
    { id: 7, title: 'Stage 7: JavaScript in the Browser vs. Node.js', objective: 'Understand the key differences between running JavaScript on the client-side (browsers) and the server-side (Node.js).' },
    ...
    { id: 9, title: 'Stage 9: JavaScript Frameworks & Specializations', objective: 'Learn a modern frontend framework (React recommended) to build complex, scalable single-page applications.' },
    ...
    { id: 14, title: 'Stage 14: Real-World Projects (Beginner → Advanced)', objective: 'Synthesize all learned skills into a portfolio of tangible, real-world projects that demonstrate job-ready capabilities.' },
