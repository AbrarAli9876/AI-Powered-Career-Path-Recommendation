...
const careerPaths = [
  { name: 'Data Scientist', path: '/data-scientist', description: 'Extract insights from data to drive business decisions.' },
  { name: 'AI Engineer', path: '/ai-engineer', description: 'Design, build, and deploy complex AI and machine learning systems.' },
  { name: 'Machine Learning Engineer', path: '/ml-engineer', description: 'Operationalize ML models and build production-grade AI pipelines.' },
  ...
  { name: 'Blockchain Developer', path: '#', description: 'Build decentralized applications and smart contracts on blockchain platforms. (Coming Soon)' },
  { name: 'IoT Developer', path: '#', description: 'Develop software for embedded devices and the Internet of Things ecosystem. (Coming Soon)' },
  { name: 'AI Prompt Engineer', path: '#', description: 'Craft and optimize prompts to effectively communicate with large language models. (Coming Soon)' },
  { name: 'Low-Code / No-Code Developer', path: '#', description: 'Build applications and automations using visual development platforms. (Coming Soon)' },
];
